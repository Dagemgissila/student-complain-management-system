          ...
          <div id="case-container">
              <div id="case-nav">
               ...
               <li><a href="managestudent.php">manage student</a></li>
                   ...
                   <li><a href="casereport.php">case reports <?php 
                           ...
                           ?>
                           <span style="background-color:yellow;padding:10px;margin:10px;color:red;font-weigth:bold;font-size:55px;border:1px solid red;border-radius:20px;">
             ...
             <div id="case-description">
                 <table id="list">
                     ...
                     $result="select * FROM studentcase where status='0'";
